...
for p in img_2Dimension: #recorre cada pixel 
    if (p[0]>(1.5*int(p[1])) and p[0]>(1.5*int(p[2]))): #Si  la componente r del pixel es mayor que la compontente g y b multiplicadas por 1.5 guarda el valor de r en red_values
